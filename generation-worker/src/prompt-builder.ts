...
export function capabilityCatalog(settings: GenerationSettings, browserTheme: BrowserTheme): CapabilityCatalog {
  ...
  return {
    ...
    fonts: GENERATION_EXPERIENCE_REGISTRY[browserTheme].fonts,
    capabilities,
    ...
    rendererConstraints: [
      ...
      GENERATION_EXPERIENCE_REGISTRY[browserTheme].fontInstruction,
...
export function buildPrompt(input: PromptInput): PromptBundle {
  ...
  const fallbackThemeInstruction = GENERATION_EXPERIENCE_REGISTRY[browserTheme].worldInstruction;
