// Tailwind CSS 4.3.3 default theme, embedded so the compiled sidecar is self-contained.
// `inline` keeps the generated artifact CSS page-specific instead of emitting a
// shared visual theme or a large block of unused custom properties.
export const TAILWIND_DEFAULT_THEME = String.raw`
